...
begin
  ...
  if cron_auth_token is null then
    cron_auth_token := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpocG16cXhxdmFwZGt5dnZoeXJhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM1MTg2MDMsImV4cCI6MjA4OTA5NDYwM30.OKZtSANaGsqOVLK1bqjYEeVvSMvRp8uFsIsjiscgpI0'; -- gitleaks:allow
  end if;
